...
{
    public class ATTLeaveTypeEmployee
    {
        ...
        public ATTLeaveTypeEmployee()
        { }
        public ATTLeaveTypeEmployee(int leaveTypeId, string leaveType, int empID, int days, string periodType, int periodTimes, bool isAccural, int accuralDays, bool active, string effectiveFromDate, string entryBy, string entryDate)
        {
