...
{
    public class ATTPersonTraining
    {
        ...
        public ATTPersonTraining()
        {
        }

        public ATTPersonTraining(double empID, int seqNo, string subject, string certificateName, long? institutionID, string fromDate, string toDate, string grade, float? percentage, string remarks, string entryBy)
        {
            this.EmpID = empID;
            this.SeqNo = seqNo;
