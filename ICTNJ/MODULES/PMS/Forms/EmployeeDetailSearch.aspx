<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeDetailSearch.aspx.cs" Inherits="MODULES_PMS_Forms_EmployeeDetailSearch" Title="PMS | Employee Detail Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="width:100%; height:auto">
        ...
        <asp:Label ID="Label18" runat="server" SkinID="UnicodeHeadlbl" Text="ब्रिहत कर्मचारी खोजी"></asp:Label>
        <br />
        <br />
        <table id="TABLE1" width="900">
            ...
            <tr>
                ...
                <td style="width: 200px">
                    <asp:DropDownList ID="ddlSewa" runat="server" Width="182px" AutoPostBack="True" OnSelectedIndexChanged="ddlSewa_SelectedIndexChanged" SkinID="Unicodeddl">
                    </asp:DropDownList></td>
                <td style="width: 100px">
                ...
                <td style="width: 200px">
                    <asp:UpdatePanel id="updSamuha" runat="server">
                        <contenttemplate>
<asp:DropDownList id="ddlSamuha" runat="server" Width="182px" SkinID="Unicodeddl" OnSelectedIndexChanged="ddlSamuha_SelectedIndexChanged" AutoPostBack="True" __designer:wfdid="w11" AppendDataBoundItems="True"></asp:DropDownList> 
</contenttemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="ddlSewa" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
                ...
                <td style="width: 200px">
                    <asp:UpdatePanel id="updUpaSamuha" runat="server">
                        <contenttemplate>
<asp:DropDownList id="ddlUpaSamuha" runat="server" Width="182px" SkinID="Unicodeddl" __designer:wfdid="w13" AppendDataBoundItems="True"></asp:DropDownList> 
</contenttemplate>
                        <triggers>
            ...
            <tr>
                ...
                <td style="width: 200px">
                    <asp:UpdatePanel id="updPost" runat="server">
                        <contenttemplate>
<asp:DropDownList id="ddlPost" runat="server" Width="182px" SkinID="Unicodeddl" __designer:wfdid="w12"></asp:DropDownList> 
</contenttemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="ddlOrganization" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
                ...
                <td style="width: 200px">
                    <asp:DropDownList ID="ddlLevel" runat="server" Width="182px" SkinID="Unicodeddl">
                    </asp:DropDownList></td>
                <td style="width: 100px">
                    <asp:Label ID="Label16" runat="server" SkinID="Unicodelbl" Text="नियुत्तिको प्रकार"></asp:Label></td>
                <td style="width: 200px"><asp:DropDownList ID="ddlPostingType" runat="server" Width="182px" SkinID="Unicodeddl">
                </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 100px">
                ...
                <td style="width: 200px">
                    <asp:DropDownList ID="ddlSex" runat="server" Width="182px" SkinID="Unicodeddl">
                ...
                <td style="width: 200px">
                    <asp:DropDownList ID="ddlDistrict" runat="server" Width="181px" SkinID="Unicodeddl">
                    </asp:DropDownList></td>
                <td style="width: 100px">
                </td>
                <td style="width: 200px">
        ...
        <asp:Panel ID="pnlSearch" runat="server" Height="400px" ScrollBars="Auto" Width="95%">
            <asp:GridView ID="grdEmployee" runat="server" CellPadding="0" ForeColor="#333333" SkinID="Unicodegrd" OnDataBound="grdEmployee_DataBound" OnRowDataBound="grdEmployee_RowDataBound" AutoGenerateColumns="False" Width="2300px">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="क्र.सं" DataField="EmpID">
