<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="PersonSearch.aspx.cs" Inherits="MODULES_PMS_Forms_PersonSearch" Title="PMS | Person Search" %>
<%@ Register 
...
<asp:Panel id="Panel1" runat="server" Width="100%" Height="350px" ScrollBars="Auto" __designer:wfdid="w13"><asp:Label id="lblSearch" runat="server" Font-Bold="True" __designer:dtid="281474976710668" __designer:wfdid="w14"></asp:Label><BR /><asp:GridView id="grdPerson" runat="server" Width="848px" SkinID="PCSGridView" ForeColor="#333333" __designer:wfdid="w15" CellPadding="0" AutoGenerateColumns="False" OnRowDataBound="grdPerson_RowDataBound" OnRowCreated="grdPerson_RowCreated">
