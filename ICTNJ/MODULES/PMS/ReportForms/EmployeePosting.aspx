<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="EmployeePosting.aspx.cs" Inherits="MODULES_PMS_Report_Forms_EmployeePosting" Title="Employee Posting Report Generate" %>
...
<asp:Button ID="OkButton" runat="server" Text="OK" OnClick="hideModalPopupViaServer_Click" Width="58px" />&nbsp;
    ...
    <br />
    <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="कर्मचारी नियुक्ति विवरण"></asp:Label><br />
    <br />
...
<div style="text-align: left">
    <table width="900" >
        ...
        <tr>
            <td colspan="5" style="height: 12px">
                ...
                <asp:DropDownList ID="ddlReportType" runat="server" Width="179px" SkinID="Unicodeddl">
                    ...
                    <asp:ListItem Value="4">कर्मचारीबाट</asp:ListItem>
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td colspan="5" style="height: 12px">
        ...
        <tr>
            <td colspan="5" style="height: 12px">
                <asp:Button ID="btnGenerateReport" runat="server" OnClick="Button1_Click" Text="View Report" ToolTip="Generates Employee Posting Report" Width="92px" SkinID="Normal" />
