<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeBioData.aspx.cs" Inherits="MODULES_PMS_ReportForms_EmployeeBioData" Title="PMS | Employee Bio Data" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:Label ID="Label7" runat="server" SkinID="UnicodeHeadlbl" Text="कर्मचारीको वायोदाटाको विवरण"></asp:Label><br />
    <br />
    <div id="upper" style="width: 949px; height: 27px">
        कर्मचारी खोज्नुहोस्
    </div>
                ...
                <asp:Panel ID="Panel3" runat="server" Width="100%">
                    <table width="900">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:DropDownList ID="ddlOrganization" runat="server" SkinID="Unicodeddl" Width="443px">
                                </asp:DropDownList></td>
                            <td style="width: 115px;">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                &nbsp;<asp:UpdatePanel id="UpdatePanel1" runat="server">
                                    <contenttemplate>
<asp:Label id="lblSearch" runat="server" Font-Bold="True"></asp:Label> <BR /><asp:Panel id="Panel1" runat="server" Width="890px" Height="150px" ScrollBars="auto"><asp:GridView id="grdEmployee" runat="server" Width="800px" SkinID="Unicodegrd" OnRowCreated="grdEmployee_RowCreated" ForeColor="#333333" CellPadding="0" AutoGenerateColumns="False" OnRowCommand="grdEmployee_RowCommand">
