<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="EmployeeVisit.aspx.cs" Inherits="MODULES_PMS_ReportForms_EmployeeVisit2" Title="PMS | Employee Visit Report Form" %>
<%@ Register 
...
<asp:Button ID="OkButton" runat="server" Text="OK" OnClick="hideModalPopupViaServer_Click" Width="58px" />&nbsp;
    ...
    <br />
    <asp:Label ID="Label3" runat="server" SkinID="UnicodeHeadlbl" Text="कर्मचारीको विदेश भ्रमणको विवरण"></asp:Label><br />
    <br />
        ...
        <table width="900">
            ...
            <tr>
                <td colspan="4" style="height: 21px">
                    <asp:Button ID="btnGenerate" runat="server" OnClick="btnGenerate_Click" Text="View Report" Width="82px" SkinID="Normal" />
