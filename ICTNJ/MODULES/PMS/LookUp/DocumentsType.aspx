...
<asp:Button ID="OkButton" runat="server" Text="OK" OnClick="hideModalPopupViaServer_Click" Width="58px" />           <br />
    ...
    <table style="width: 700px">
        <tr>
            <td style="width: 18px; height: 350px" valign="top">
            </td>
            <td style="width: 190px; height: 350px" valign="top">
                <asp:Panel ID="Panel1" runat="server" Height="180px" ScrollBars="Auto" Width="175px">
                <asp:ListBox ID="DocumentsTypeList" runat="server" Height="175px" OnSelectedIndexChanged="DocumentsTypeList_SelectedIndexChanged"
                    SkinID="Unicodelst" Width="170px" AutoPostBack="True"></asp:ListBox></asp:Panel>
            </td>
            <td valign="top" style="height: 350px">
                <table style="width: 350px">
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top">
                            <asp:Button ID="btnOK" runat="server" OnClick="btnOK_Click" Text="Submit" Width="60px" OnClientClick="javascript:return validate();" SkinID="Normal" /><asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="Cancel"
