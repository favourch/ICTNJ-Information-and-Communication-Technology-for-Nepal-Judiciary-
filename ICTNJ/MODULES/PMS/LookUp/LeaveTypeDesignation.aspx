<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="LeaveTypeDesignation.aspx.cs" Inherits="MODULES_PMS_LookUp_LeaveTypeDesignation" Title="PMS | Designationwise Leave" %>
        ...
        <tr>
            ...
            <td style="width: 130px" valign="top">
                <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" OnClientClick="javascript:return ValidatePage();"
                    Text="Add" SkinID="Add" Width="50px" /></td>
            <td style="width: 220px" valign="top">
            </td>
    ...
    <table style="width: 400px">
        <tr>
            <td colspan="2" style="width: 215px">
                &nbsp; &nbsp;
                <asp:Button ID="btnSave" runat="server" Text="Submit" OnClick="btnSave_Click" SkinID="Normal" /><asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click" SkinID="Cancel" /></td>
        </tr>
    </table>
</asp:Content>
