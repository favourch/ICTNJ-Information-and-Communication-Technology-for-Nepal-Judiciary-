<%@ Page Language="C#" MasterPageFile="~/MODULES/PMS/PMSMasterPage.master" AutoEventWireup="true" CodeFile="Sewa.aspx.cs" Inherits="MODULES_PMS_LookUp_Sewa" Title="PMS | Sewa" %>
...
<asp:Button ID="OkButton" runat="server" Text="OK" OnClick="hideModalPopupViaServer_Click" Width="58px" />           <br />
    ...
    <br />
    <asp:Label ID="Label7" runat="server" SkinID="UnicodeHeadlbl" Text="सेवा"></asp:Label>
    <br />
    <br />
        ...
        <table width="700">
            <tr>
                <td style="width: 250px" valign="top">
                    <asp:ListBox ID="lstSewa" runat="server" Height="394px" Width="315px" AutoPostBack="True" OnSelectedIndexChanged="lstSewa_SelectedIndexChanged" SkinID="Unicodelst"></asp:ListBox></td>
                <td style="width: 450px" valign="top">
                    <table width="450">
                        ...
                        <tr>
                            ...
                            <td style="width: 300px">
                                <asp:TextBox ID="txtSamuha" runat="server" Width="250px" MaxLength="48" SkinID="Unicodetxt"></asp:TextBox>&nbsp;<asp:Button ID="btnAddSamuha" runat="server" Font-Bold="False" Text="Add" OnClick="btnAddSamuha_Click" SkinID="Add" Width="50px" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 300px; height: 16px;">
                                <asp:TextBox ID="txtUpaSamuha" runat="server" Width="250px" MaxLength="48" SkinID="Unicodetxt"></asp:TextBox>&nbsp;<asp:Button ID="btnAddUpaSamuha" runat="server" Font-Bold="False" Text="Add" OnClick="btnAddUpaSamuha_Click" SkinID="Add" Width="50px" /></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <hr />
