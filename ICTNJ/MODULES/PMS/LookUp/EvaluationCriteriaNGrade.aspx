...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="width:100%; height:auto">
        ...
        <asp:Label ID="Label9" runat="server" SkinID="UnicodeHeadlbl"
            Text="मूल्यांकनको कार्य विवरण र भार"></asp:Label><br />
        <table width="800">
            <tr>
                <td style="width: 24483px; height: 404px" valign="top">
                </td>
                <td width="250" style="height: 404px" valign="top">
                    <asp:ListBox ID="lstCriteria" runat="server" Height="400px" SkinID="Unicodelst" Width="260px" AutoPostBack="True" OnSelectedIndexChanged="lstCriteria_SelectedIndexChanged"></asp:ListBox></td>
                <td style="width: 550px; height: 404px;" valign="top">
                    <table width="550">
                        ...
                        <tr>
                            ...
                            <td style="width: 470px">
                                <asp:TextBox ID="txtCriteria_rqd" runat="server" Width="300px" SkinID="Unicodetxt" ToolTip="Criteria Name" MaxLength="145" Height="150px" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 80px">
                        ...
                        <tr>
                            ...
                            <td style="width: 470px; height: 21px">
                                ...
                                &nbsp; &nbsp; &nbsp;<asp:Button ID="btnAddWeight" runat="server" SkinID="Add" Text="Add" Width="50px" /></td>
                        </tr>
                        <tr>
