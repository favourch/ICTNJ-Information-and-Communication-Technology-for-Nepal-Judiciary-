<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberPersonSearch.ascx.cs" Inherits="MODULES_OAS_UserControls_GroupMemberPersonSearch" %>
...
<div style="width:100%; height:auto">
    ...
    <asp:Label ID="Label22" runat="server" SkinID="UnicodeHeadlbl" Text="कर्मचारी खोज्नुहोस"></asp:Label>
    <ajaxToolkit:FilteredTextBoxExtender ID="fltSymbolNo" runat="server" FilterType="Numbers" TargetControlID="txtSymbolNo">
    </ajaxToolkit:FilteredTextBoxExtender>
    <table style="width: 939px">
        <tr>
            <td style="width: 125px">
                <asp:Label ID="Label30" runat="server" Height="22px" SkinID="Unicodelbl" Text="संकेत नं" Visible="False"></asp:Label></td>
            <td>
        ...
        <tr>
            <td style="width: 125px">
                &nbsp;&nbsp;
                <asp:Label ID="Label1" runat="server" Height="22px" SkinID="Unicodelbl" Text="पहिलो नाम"></asp:Label></td>
            <td>
        ...
        <tr>
            <td style="width: 125px">
                <asp:Label ID="Label8" runat="server" SkinID="Unicodelbl" Text="कमिटि" Visible="False"></asp:Label></td>
            <td>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlCommittee" runat="server" Width="135px" AutoPostBack="True" OnSelectedIndexChanged="ddlCommittee_SelectedIndexChanged" Visible="False">
                        </asp:DropDownList>
                    </ContentTemplate>
                    <Triggers>
            ...
            <td>
                <asp:Label ID="Label9" runat="server" Height="22px" SkinID="Unicodelbl" Text="कमिटिको पद" Width="110px" Visible="False"></asp:Label></td>
            <td colspan="2">
                <asp:DropDownList ID="ddlCommitteePost" runat="server" Width="220px" Visible="False">
                </asp:DropDownList></td>
            <td>
            </td>
        </tr>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlEmployee" runat="server" Width="100%" CssClass="ChnlPersonDynamicPanel">
            <asp:GridView ID="grdEmployee" runat="server" AutoGenerateColumns="False" CellPadding="0" ForeColor="#333333" OnDataBound="grdEmployee_DataBound" OnRowDataBound="grdEmployee_RowDataBound"
                OnSelectedIndexChanged="grdEmployee_SelectedIndexChanged" SkinID="Unicodegrd" Width="95%">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="GroupName" HeaderText="कमिटि" />
                    <asp:BoundField DataField="GMPositionName" HeaderText="कमिटिको पद" />
