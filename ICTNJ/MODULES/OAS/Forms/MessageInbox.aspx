<%@ Page Language="C#" EnableEventValidation = "false" MasterPageFile="~/MODULES/OAS/MasterPage.master" AutoEventWireup="true" CodeFile="MessageInbox.aspx.cs" Inherits="MODULES_OAS_Forms_MessageInbox" Title=":.Message Inbox" %>
...
<asp:ScriptManager id="ScriptManager1" runat="server">
     ...
     <script language="javascript" type="text/javascript">
        ...
        function CheckUncheckAll(obj)
        {
            try
            {   
                 var grid = document.getElementById("<%= grdMessageInbox.ClientID %>");
                ...
                <table width ="80%" cellpadding ="0"  cellspacing ="0" border ="0" style ="border-color:Red">
                   <tr>
                        <td style ="height: 50px;" align="left">
                            <asp:Label ID="lblHeader" runat="server" SkinID="UnicodeHeadlbl" Text="Inbox"></asp:Label></td>
                   </tr>
                    <tr>
                        ...
                        <td align = "left">
                            ...
                            <table width ="100%" cellpadding ="0"  cellspacing ="0" border ="0" style ="border-color:blue">
                                <TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 48px" align=left>
                                 <asp:CheckBox id="chkAllInbox" runat="server"  AutoPostBack="True"></asp:CheckBox> <asp:Label id="lblSelectAllPpl" runat="server" Text="Select All"></asp:Label> </TD>
                                 ...
                                 <tr>
                                    <td  colspan = "2" align ="left" style="padding-left:44px;">
                                         <asp:UpdatePanel id="updMsgInbox" runat="server">
                                            <contenttemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 400px" border="0"><asp:GridView id="grdMessageInbox" runat="server" Width="91%" Font-Size="Smaller" Font-Names="Verdana" ForeColor="#333333" EnableTheming="False" OnRowDataBound="grdMessageInbox_RowDataBound" OnSelectedIndexChanged="grdMessageInbox_SelectedIndexChanged" OnRowCreated="grdMessageInbox_RowCreated" ShowHeader="False" GridLines="None" CellPadding="4" AutoGenerateColumns="False" __designer:wfdid="w1">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="2%"></ItemStyle>
<ItemTemplate>
<asp:CheckBox id="chkInboxMsg" runat="server" __designer:wfdid="w10"></asp:CheckBox> 
</ItemTemplate>
</asp:TemplateField>
...
<ItemStyle Width="2%"></ItemStyle>
<ItemTemplate>
<asp:Image id="imgMail" runat="server" ImageUrl="~/MODULES/OAS/Images/Cmail.jpg" __designer:wfdid="w9"></asp:Image> 
</ItemTemplate>
</asp:TemplateField>
...
<asp:BoundField DataField="MsgSeq"></asp:BoundField>
<asp:BoundField DataField="MsgGrpType"></asp:BoundField>
<asp:BoundField DataField="READ" HeaderText="READ"></asp:BoundField>
<asp:BoundField DataField="MessageTypeID" HeaderText="MessageTypeID"></asp:BoundField>
<asp:BoundField DataField="TippaniOrgID" HeaderText="TippaniOrgID"></asp:BoundField>
...
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
                                             ...
                                             <triggers>
<asp:AsyncPostBackTrigger ControlID="chkAllInbox" EventName="CheckedChanged"></asp:AsyncPostBackTrigger>
<asp:AsyncPostBackTrigger ControlID="txtSearch" EventName="TextChanged"></asp:AsyncPostBackTrigger>
</triggers>
                                         </asp:UpdatePanel>
                                    </td>
                               </tr>
