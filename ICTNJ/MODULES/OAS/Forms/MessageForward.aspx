<%@ Page Language="C#" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/MODULES/OAS/MasterPage.master" ValidateRequest = "false" AutoEventWireup="true" CodeFile="MessageForward.aspx.cs"
    Inherits="MODULES_OAS_Forms_MessageForward" Title="OAS|Message Forward" %>
                    ...
                    <table width="80%" cellpadding="0" cellspacing="0" border="0" style="border-color: Red">
                        <tr>
                            <td style="height: 50px;" align="left">
                                <asp:Label ID="lblHeader" runat="server" SkinID="UnicodeHeadlbl" Text="Message Forward"></asp:Label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center">
                                <asp:UpdatePanel id="updEditor" runat="server">
                                    <contenttemplate>
<FIELDSET><TABLE style="BORDER-LEFT-COLOR: blue; BORDER-BOTTOM-COLOR: blue; BORDER-TOP-COLOR: blue; BORDER-RIGHT-COLOR: blue" cellSpacing=0 cellPadding=0 width="80%" border=0><TBODY><TR><TD style="WIDTH: 70px" class="tblTDRight"><asp:Button id="btnTo" onclick="btnTo_Click" runat="server" Width="69px" Text="          To :" SkinID="Normal" OnClientClick='javascript:ShowDiv("dvReceipient");' __designer:wfdid="w79"></asp:Button></TD><TD style="WIDTH: 621px; PADDING-TOP: 5px" class="tblTDLeft" vAlign=bottom><DIV style="VERTICAL-ALIGN: top; OVERFLOW: auto; WIDTH: 600px; max-height: 48px" id="dvReceiver" border="0"><asp:DataList id="dlReceiver" runat="server" Width="581px" Font-Size="2px" BackColor="LightGoldenrodYellow" __designer:wfdid="w80" BorderWidth="1px" OnSelectedIndexChanged="dlReceiver_SelectedIndexChanged" RepeatColumns="4" BorderColor="Tan"><ItemTemplate>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <DIV style="BORDER-RIGHT: #d2b48c 1px solid; BORDER-TOP: #d2b48c 1px solid; BORDER-LEFT: #d2b48c 1px solid; BORDER-BOTTOM: #d2b48c 1px solid"><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR><TD style="WIDTH: 80%"><asp:Label id="lblReceiver" runat="server" Text='<%# Eval("DisplayName") %>' Font-Size="X-Small" Font-Names="Verdana" EnableTheming="True" BackColor="White" ToolTip='<%# Eval("DetailName") %>' __designer:wfdid="w71" CausesValidation="False"></asp:Label> </TD><TD style="PADDING-RIGHT: 2px" align=right>&nbsp;&nbsp;<asp:ImageButton id="imgBtnRemove1" onclick="imgBtnRemove1_Click" runat="server" ImageUrl="~/MODULES/OAS/Images/bycat1.ico" BackColor="White" __designer:wfdid="w72" CommandName="Select" CommandArgument='<%# Eval("OtherReceiverID")  + "/" + Eval("ReceiverOrgID") + "/" + Eval("GroupID")+ "/" + Eval("ReceiverType") + "/" + Eval("ISCC") %>'></asp:ImageButton> </TD></TR></TBODY></TABLE></DIV>
</ItemTemplate>

<AlternatingItemStyle BorderColor="Tan"></AlternatingItemStyle>
</asp:DataList> </DIV></TD></TR><TR><TD style="WIDTH: 70px; HEIGHT: 32px" class="tblTDRight"><asp:Label id="lblFrom" runat="server" Text="From :" __designer:wfdid="w81"></asp:Label> </TD><TD style="WIDTH: 621px; HEIGHT: 32px" class="tblTDLeft"><asp:Label id="lblUserName" runat="server" __designer:wfdid="w82"></asp:Label> </TD></TR><TR><TD style="WIDTH: 70px" class="tblTDRight"><asp:Label id="lblSubject" runat="server" Text="Subject :" __designer:wfdid="w83"></asp:Label> </TD><TD style="WIDTH: 621px" class="tblTDLeft"><asp:TextBox id="txtSubject_rqd" runat="server" Width="594px" __designer:wfdid="w84" ToolTip="Subject"></asp:TextBox> </TD></TR><TR><TD style="WIDTH: 70px; HEIGHT: 31px" class="tblTDRight"><asp:Label id="lblAttach" runat="server" Text="Attach " __designer:wfdid="w85"></asp:Label> <asp:Image id="Image1" runat="server" ImageUrl="~/MODULES/OAS/Images/i_attach.gif" __designer:wfdid="w86"></asp:Image></TD><TD style="WIDTH: 621px; HEIGHT: 31px" class="tblTDLeft"><asp:FileUpload id="fupdAttach" runat="server" Width="272px" Font-Size="Small" Font-Names="Verdana" __designer:wfdid="w87"></asp:FileUpload>&nbsp;&nbsp;<asp:Button id="btnUpload" onclick="btnUpload_Click" runat="server" Width="35px" Text="Add" SkinID="Normal" __designer:wfdid="w88"></asp:Button></TD></TR><TR><TD style="WIDTH: 70px; HEIGHT: 31px" class="tblTDRight"></TD><TD style="PADDING-BOTTOM: 10px; WIDTH: 621px; HEIGHT: 37px" class="tblTDLeft"><DIV style="VERTICAL-ALIGN: top; OVERFLOW: auto; WIDTH: 610px; max-height: 50px" id="dvAttachment" border="0"><asp:DataList id="dlUpdAttachment" runat="server" Width="581px" Height="11px" Font-Size="2px" BackColor="LightGoldenrodYellow" ForeColor="Black" __designer:wfdid="w89" BorderWidth="1px" OnSelectedIndexChanged="dlUpdAttachment_SelectedIndexChanged" RepeatColumns="4" BorderColor="Tan" CellPadding="2">
...
</asp:DataList> </DIV></TD></TR><TR><TD style="WIDTH: 70px; HEIGHT: 31px" class="tblTDRight"></TD><TD style="PADDING-LEFT: 20px; PADDING-BOTTOM: 10px; WIDTH: 621px; HEIGHT: 37px" class="tblTDLeft"><FTB:FreeTextBox id="HtmlEditor1" runat="server" Width="600px" Height="250px" BackColor="127, 157, 185" __designer:wfdid="w90" BreakMode="LineBreak" GutterBackColor="127, 157, 185" StartMode="DesignMode" ToolbarBackColor="127, 157, 185" ToolbarLayout="ParagraphMenu,FontFacesMenu,FontSizesMenu,FontForeColorsMenu|Bold,Italic,Underline,Strikethrough;Superscript,Subscript,RemoveFormat|JustifyLeft,JustifyRight,JustifyCenter,JustifyFull;BulletedList,NumberedList,Indent,Outdent;InsertRule|Cut,Copy,Paste;Undo,Redo,Print">
                </FTB:FreeTextBox></TD></TR><TR><TD style="WIDTH: 70px" class="tblTDRight"><asp:Button id="btnCc" onclick="btnCc_Click" runat="server" Width="69px" Text="          Cc :" SkinID="Normal" OnClientClick='javascript:ShowDiv("dvReceipientCc");' __designer:wfdid="w91"></asp:Button></TD><TD style="WIDTH: 621px; PADDING-TOP: 10px" class="tblTDLeft"><DIV style="VERTICAL-ALIGN: top; OVERFLOW: auto; WIDTH: 600px; max-height: 48px" id="dvCcReceiver" onclick="return dvCcReceiver_onclick()" border="0"><asp:DataList id="dlReceiverCc" runat="server" Width="581px" Font-Size="2px" BackColor="LightGoldenrodYellow" __designer:wfdid="w92" BorderWidth="1px" OnSelectedIndexChanged="dlReceiverCc_SelectedIndexChanged" RepeatColumns="4" BorderColor="Tan"><ItemTemplate>
...
<AlternatingItemStyle BorderColor="Tan"></AlternatingItemStyle>
</asp:DataList> </DIV></TD></TR><TR><TD style="WIDTH: 70px"><asp:Label id="lblApprove" runat="server" Text="Approve :" __designer:wfdid="w93"></asp:Label></TD><TD style="WIDTH: 621px" class="tblTDLeft"><asp:CheckBox id="chkApprove" runat="server" __designer:wfdid="w94"></asp:CheckBox>&nbsp; <asp:Label id="lbltitle" runat="server" Text="( यस बमोजिम स्वीकार्थ पेश गरेको छु । )" SkinID="Unicodelbl" __designer:wfdid="w95"></asp:Label></TD></TR></TBODY></TABLE></FIELDSET> 
</contenttemplate>
                                    <triggers>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 27px" align=left colSpan=2><TABLE style="WIDTH: 451px"><TBODY><TR><TD style="WIDTH: 75px"><asp:Label id="Label2" runat="server" Text="पठाउनु पर्ने" __designer:wfdid="w55"></asp:Label> </TD><TD style="WIDTH: 131px" class="tblTDLeft"><asp:DropDownList id="ddlFilterReceiver" runat="server" OnSelectedIndexChanged="ddlFilterReceiver_SelectedIndexChanged" __designer:wfdid="w56" AutoPostBack="True"><asp:ListItem Value="-1">छान्नुहोस्</asp:ListItem>
<asp:ListItem Value="1">संस्था</asp:ListItem>
<asp:ListItem Value="2">शाखा</asp:ListItem>
<asp:ListItem Value="3">व्यक्ति</asp:ListItem>
</asp:DropDownList> </TD><TD><asp:Label id="lblOrganisation" runat="server" Text="संस्था" __designer:wfdid="w57"></asp:Label> </TD><TD class="tblTDLeft"><asp:DropDownList id="ddlOrg" runat="server" Width="200px" OnSelectedIndexChanged="ddlOrg_SelectedIndexChanged" __designer:wfdid="w58" AutoPostBack="True" Enabled="False"></asp:DropDownList> </TD></TR><TR><TD style="WIDTH: 75px; HEIGHT: 32px"></TD><TD style="WIDTH: 131px; HEIGHT: 32px" class="tblTDLeft"></TD><TD style="HEIGHT: 32px"><asp:Label id="lblUnit" runat="server" Text="शाखा" __designer:wfdid="w59"></asp:Label> </TD><TD style="HEIGHT: 32px" class="tblTDLeft"><asp:DropDownList id="ddlUnit" runat="server" Width="122px" OnSelectedIndexChanged="ddlUnit_SelectedIndexChanged" __designer:wfdid="w60" AutoPostBack="True" Enabled="False"></asp:DropDownList> <asp:ImageButton id="imgPplBooking" onclick="imgPplBooking_Click" runat="server" ImageUrl="~/MODULES/OAS/Images/Book [1600x1200].jpg" ToolTip="नयाँ स्थल बुकिङ्ग" __designer:wfdid="w67"></asp:ImageButton></TD></TR></TBODY></TABLE></TD></TR><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left colSpan=1><asp:UpdatePanel id="UpdatePanel111" runat="server" __designer:wfdid="w61"><ContentTemplate>
<asp:CheckBox id="chkAllPeople" runat="server" __designer:wfdid="w62"></asp:CheckBox> <asp:Label id="lblSelectAllPpl" runat="server" Text="Select All" __designer:wfdid="w63"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right><asp:TextBox id="txtSearchPeople" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w64" OnTextChanged="txtSearchPeople_TextChanged" AutoPostBack="True"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updPeople" runat="server" __designer:wfdid="w65"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 217px" id="divGridPpl" border="0"><asp:GridView id="grdPeople" runat="server" Width="300px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w66" OnRowCreated="grdPeople_RowCreated" ShowHeader="False" GridLines="None" OnRowDataBound="grdPeople_RowDataBound">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left><asp:UpdatePanel id="UpdatePanel11" runat="server" __designer:wfdid="w189"><ContentTemplate>
<asp:CheckBox id="chkAllCategories" runat="server" __designer:wfdid="w190"></asp:CheckBox> <asp:Label id="lblSelectAllCategories" runat="server" Text="Select All" __designer:wfdid="w191"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right><asp:TextBox id="txtSearchCategory" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w192" AutoPostBack="True" OnTextChanged="txtSearchCategory_TextChanged"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updCategory" runat="server" __designer:wfdid="w193"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 213px" id="divGridGrp" border="0"><asp:GridView id="grdCategory" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w194" OnRowDataBound="grdCategory_RowDataBound" GridLines="None" ShowHeader="False" OnRowCreated="grdCategory_RowCreated" AutoGenerateColumns="False">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left><asp:UpdatePanel id="updChkGroup" runat="server" __designer:wfdid="w201"><ContentTemplate>
<asp:CheckBox id="chkAllGroups" runat="server" __designer:wfdid="w202"></asp:CheckBox> <asp:Label id="lblSelectAllGroups" runat="server" Text="Select All" __designer:wfdid="w203"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right>&nbsp;<asp:TextBox id="txtSearchGroup" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w204" OnTextChanged="txtSearchGroup_TextChanged" AutoPostBack="True"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updGroup" runat="server" __designer:wfdid="w205"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 213px" id="Div2" border="0"><asp:GridView id="grdGroup" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w206" GridLines="None" ShowHeader="False" OnRowCreated="grdGroup_RowCreated" AutoGenerateColumns="False">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 27px; HEIGHT: 25px" align=left colSpan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </TD></TR><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 27px; HEIGHT: 24px" align=left colSpan=2><TABLE style="WIDTH: 451px"><TBODY><TR><TD style="WIDTH: 75px"><asp:Label id="Label22" runat="server" Text="पठाउनु पर्ने" __designer:wfdid="w171"></asp:Label> </TD><TD style="WIDTH: 131px" class="tblTDLeft"><asp:DropDownList id="ddlFilterCcReceiver" runat="server" OnSelectedIndexChanged="ddlFilterCcReceiver_SelectedIndexChanged" __designer:wfdid="w172" AutoPostBack="True"><asp:ListItem Value="-1">छान्नुहोस्</asp:ListItem>
<asp:ListItem Value="1">संस्था</asp:ListItem>
<asp:ListItem Value="2">शाखा</asp:ListItem>
<asp:ListItem Value="3">व्यक्ति</asp:ListItem>
</asp:DropDownList> </TD><TD>&nbsp;<asp:Label id="lblOrganisationCc" runat="server" Text="संस्था" __designer:wfdid="w173"></asp:Label> </TD><TD class="tblTDLeft"><asp:DropDownList id="ddlOrgCc" runat="server" Width="201px" OnSelectedIndexChanged="ddlOrgCc_SelectedIndexChanged" __designer:wfdid="w174" AutoPostBack="True"></asp:DropDownList> </TD></TR><TR><TD style="WIDTH: 75px; HEIGHT: 32px"></TD><TD style="WIDTH: 131px; HEIGHT: 32px" class="tblTDLeft"></TD><TD style="HEIGHT: 32px">&nbsp;<asp:Label id="lblUnitCc" runat="server" Text="शाखा" __designer:wfdid="w175"></asp:Label> </TD><TD style="HEIGHT: 32px" class="tblTDLeft"><asp:DropDownList id="ddlUnitCc" runat="server" Width="122px" OnSelectedIndexChanged="ddlUnitCc_SelectedIndexChanged" __designer:wfdid="w176" AutoPostBack="True" Enabled="False"></asp:DropDownList> <asp:ImageButton id="imgPplBookingCc" onclick="imgPplBookingCc_Click" runat="server" ImageUrl="~/MODULES/OAS/Images/Book [1600x1200].jpg" ToolTip="नयाँ स्थल बुकिङ्ग" __designer:wfdid="w68"></asp:ImageButton></TD></TR></TBODY></TABLE></TD></TR><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left colSpan=1><asp:UpdatePanel id="UpdatePanel112" runat="server" __designer:wfdid="w177"><ContentTemplate>
<asp:CheckBox id="chkAllCcPeople" runat="server" __designer:wfdid="w178"></asp:CheckBox> <asp:Label id="lblSelectAllPplCc" runat="server" Text="Select All" __designer:wfdid="w179"></asp:Label> 
</ContentTemplate>
<Triggers>
...
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right><asp:TextBox id="txtSearchPeopleCc" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w180" OnTextChanged="txtSearchPeopleCc_TextChanged" AutoPostBack="True"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updPeopleCc" runat="server" __designer:wfdid="w181"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 217px" id="divGridPpl1" border="0"><asp:GridView id="grdPeopleCc" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w182" OnRowCreated="grdPeopleCc_RowCreated" ShowHeader="False" GridLines="None">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left><asp:UpdatePanel id="UpdatePanelCc" runat="server" __designer:wfdid="w153"><ContentTemplate>
<asp:CheckBox id="chkAllCcCategories" runat="server" __designer:wfdid="w154"></asp:CheckBox> <asp:Label id="lblSelectAllCategoriesCc" runat="server" Text="Select All" __designer:wfdid="w155"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right><asp:TextBox id="txtSearchCategoryCc" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w156" AutoPostBack="True" OnTextChanged="txtSearchCategoryCc_TextChanged"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updCategory1" runat="server" __designer:wfdid="w157"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 213px" id="div3" border="0"><asp:GridView id="grdCategoryCc" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w158" OnRowCreated="grdCategory_RowCreated" ShowHeader="False" GridLines="None" OnRowDataBound="grdCategory_RowDataBound" AutoGenerateColumns="False">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left><asp:UpdatePanel id="updChkGroupCc" runat="server" __designer:wfdid="w141"><ContentTemplate>
<asp:CheckBox id="chkAllCcGroups" runat="server" __designer:wfdid="w142"></asp:CheckBox> <asp:Label id="lblSelectAllGroupsCc" runat="server" Text="Select All" __designer:wfdid="w143"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right>&nbsp;<asp:TextBox id="txtSearchGroupCc" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w144" AutoPostBack="True" OnTextChanged="txtSearchGroupCc_TextChanged"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updGroup1" runat="server" __designer:wfdid="w145"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 213px" id="Div5" border="0"><asp:GridView id="grdGroupCc" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w146" OnRowCreated="grdGroup_RowCreated" ShowHeader="False" GridLines="None" AutoGenerateColumns="False">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
...
</ajaxToolKit:TabContainer> </TD></TR>
