<%@ Page Language="C#" MasterPageFile="~/MODULES/OAS/MasterPage.master" AutoEventWireup="true" CodeFile="MeetingVenueManagement.aspx.cs" Inherits="MODULES_OAS_Forms_MeetingVenueManagement" Title="OAS|Meeting Venue Management" %>
...
<asp:Button ID="hiddenTargetControlForBookedVenueModalPopup" runat="server" Style="display: none" />
    ...
    <asp:Panel ID="programmaticBookedVenuePopup" runat="server" BackColor="white"  Style="display: none; padding: 10px">
        ...
        <asp:UpdatePanel id="updVenueDetails" runat="server">
                <ContentTemplate>
<P style="WIDTH: 650px"><asp:ImageButton style="PADDING-RIGHT: 13px" id="imbBtnClose2" onclick="imbBtnClose2_Click" runat="server" Width="17px" ImageUrl="~/MODULES/OAS/Images/btn_cancel.gif" __designer:wfdid="w1" align="right"></asp:ImageButton> </P><asp:Panel id="programmaticBookedVenuePopupDragHandle" runat="Server" Width="660px" Height="259px" __designer:wfdid="w2"><FIELDSET style="WIDTH: 633px"><LEGEND><asp:Label id="lblTitle" runat="server" Text="स्थान तल दिएको समयमा बुकिङ्ग भइक्यो , त्यसैले अर्को समय छान्नुहोस्" EnableTheming="False"></asp:Label> </LEGEND><DIV style="OVERFLOW: auto; WIDTH: 623px; HEIGHT: 186px" border="0"><asp:GridView id="grdBooked" runat="server" Font-Size="Smaller" Font-Names="Verdana" ForeColor="#333333" EnableTheming="True" AutoGenerateColumns="False" CellPadding="4" GridLines="None" __designer:wfdid="w4">
