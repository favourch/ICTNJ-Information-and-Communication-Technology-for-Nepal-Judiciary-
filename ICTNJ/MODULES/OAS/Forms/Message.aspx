<%@ Page Language="C#" EnableEventValidation="false" MaintainScrollPositionOnPostback="true"
    MasterPageFile="~/MODULES/OAS/MasterPage.master" ValidateRequest = "false" AutoEventWireup="true" CodeFile="Message.aspx.cs"
    Inherits="MODULES_OAS_Forms_Message" Title="OAS|Message New" %>
                    ...
                    <table width="80%" cellpadding="0" cellspacing="0" border="0" style="border-color: Red">
                        <tr>
                            <td style="height: 50px;" align="left">
                                <asp:Label ID="lblHeader" runat="server" SkinID="UnicodeHeadlbl" Text="Compose"></asp:Label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center">
                                <asp:UpdatePanel id="updEditor" runat="server">
                                    <contenttemplate>
<FIELDSET><TABLE style="BORDER-LEFT-COLOR: blue; BORDER-BOTTOM-COLOR: blue; BORDER-TOP-COLOR: blue; BORDER-RIGHT-COLOR: blue" cellSpacing=0 cellPadding=0 width="80%" border=0><TBODY><TR><TD style="WIDTH: 70px" class="tblTDRight"><asp:Button id="btnTo" onclick="btnTo_Click" runat="server" Width="69px" Text="          To :" SkinID="Normal" OnClientClick='javascript:ShowDiv("dvReceipient");' __designer:wfdid="w26"></asp:Button></TD><TD style="WIDTH: 621px; PADDING-TOP: 10px; HEIGHT: 37px" class="tblTDLeft" vAlign=bottom><DIV style="VERTICAL-ALIGN: top; OVERFLOW: auto; WIDTH: 600px; max-height: 48px" id="dvReceiver" border="0"><asp:DataList id="dlReceiver" runat="server" Width="581px" Font-Size="2px" BackColor="LightGoldenrodYellow" __designer:wfdid="w27" BorderColor="Tan" RepeatColumns="4" OnSelectedIndexChanged="dlReceiver_SelectedIndexChanged" BorderWidth="1px"><ItemTemplate>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <DIV style="BORDER-RIGHT: #d2b48c 1px solid; BORDER-TOP: #d2b48c 1px solid; BORDER-LEFT: #d2b48c 1px solid; BORDER-BOTTOM: #d2b48c 1px solid"><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR><TD style="WIDTH: 80%"><asp:Label id="lblReceiver" runat="server" Text='<%# Eval("DisplayName") %>' Font-Size="X-Small" Font-Names="Verdana" EnableTheming="True" BackColor="White" ToolTip='<%# Eval("DetailName") %>' __designer:wfdid="w19" CausesValidation="False"></asp:Label> </TD><TD style="PADDING-RIGHT: 2px" align=right>&nbsp;&nbsp;<asp:ImageButton id="imgBtnRemove1" onclick="imgBtnRemove1_Click" runat="server" ImageUrl="~/MODULES/OAS/Images/bycat1.ico" BackColor="White" __designer:wfdid="w20" CommandName="Select" CommandArgument='<%# Eval("OtherReceiverID")  + "/" + Eval("ReceiverOrgID") + "/" + Eval("GroupID")+ "/" + Eval("ReceiverType") + "/" + Eval("ISCC") %>'></asp:ImageButton> </TD></TR></TBODY></TABLE></DIV>
</ItemTemplate>

<AlternatingItemStyle BorderColor="Tan"></AlternatingItemStyle>
</asp:DataList> </DIV></TD></TR><TR><TD style="WIDTH: 70px; HEIGHT: 32px" class="tblTDRight"><asp:Label id="lblFrom" runat="server" Text="From :" __designer:wfdid="w28"></asp:Label> </TD><TD style="WIDTH: 621px; HEIGHT: 32px" class="tblTDLeft"><asp:Label id="lblUserName" runat="server" __designer:wfdid="w29"></asp:Label> </TD></TR><TR><TD style="WIDTH: 70px" class="tblTDRight"><asp:Label id="lblSubject" runat="server" Text="Subject :" __designer:wfdid="w30"></asp:Label> </TD><TD style="WIDTH: 621px" class="tblTDLeft"><asp:TextBox id="txtSubject_rqd" runat="server" Width="594px" __designer:wfdid="w31" ToolTip="Subject"></asp:TextBox> </TD></TR><TR><TD style="WIDTH: 70px; HEIGHT: 31px" class="tblTDRight"><asp:Label id="lblAttach" runat="server" Text="Attach " __designer:wfdid="w32"></asp:Label> <asp:Image id="Image1" runat="server" ImageUrl="~/MODULES/OAS/Images/i_attach.gif" __designer:wfdid="w33"></asp:Image></TD><TD style="WIDTH: 621px; HEIGHT: 31px" class="tblTDLeft"><asp:FileUpload id="fupdAttach" runat="server" Width="272px" Font-Size="Small" Font-Names="Verdana" __designer:wfdid="w34"></asp:FileUpload>&nbsp;&nbsp;<asp:Button id="btnUpload" onclick="btnUpload_Click" runat="server" Width="35px" Text="Add" SkinID="Normal" __designer:wfdid="w35"></asp:Button></TD></TR><TR><TD style="WIDTH: 70px" class="tblTDRight"></TD><TD style="WIDTH: 621px" class="tblTDLeft"><DIV style="VERTICAL-ALIGN: top; OVERFLOW: auto; WIDTH: 610px; max-height: 50px" id="dvAttachment" border="0"><asp:DataList id="dlUpdAttachment" runat="server" Width="581px" Height="11px" Font-Size="2px" BackColor="LightGoldenrodYellow" ForeColor="Black" __designer:wfdid="w36" BorderColor="Tan" RepeatColumns="4" OnSelectedIndexChanged="dlUpdAttachment_SelectedIndexChanged" BorderWidth="1px" CellPadding="2">
...
</asp:DataList> </DIV></TD></TR><TR><TD style="WIDTH: 70px" class="tblTDRight"></TD><TD style="PADDING-LEFT: 20px; WIDTH: 621px" class="tblTDLeft"><FTB:FreeTextBox id="HtmlEditor1" runat="server" Width="600px" Height="250px" BackColor="127, 157, 185" __designer:wfdid="w37" ToolbarLayout="ParagraphMenu,FontFacesMenu,FontSizesMenu,FontForeColorsMenu|Bold,Italic,Underline,Strikethrough;Superscript,Subscript,RemoveFormat|JustifyLeft,JustifyRight,JustifyCenter,JustifyFull;BulletedList,NumberedList,Indent,Outdent;InsertRule|Cut,Copy,Paste;Undo,Redo,Print" ToolbarBackColor="127, 157, 185" StartMode="DesignMode" GutterBackColor="127, 157, 185" BreakMode="LineBreak">
                </FTB:FreeTextBox></TD></TR><TR><TD style="WIDTH: 70px" class="tblTDRight"><asp:Button id="btnCc" onclick="btnCc_Click" runat="server" Width="69px" Text="          Cc :" SkinID="Normal" OnClientClick='javascript:ShowDiv("dvReceipientCc");' __designer:wfdid="w38"></asp:Button></TD><TD style="WIDTH: 621px; PADDING-TOP: 10px" class="tblTDLeft"><DIV style="VERTICAL-ALIGN: top; OVERFLOW: auto; WIDTH: 600px; max-height: 48px" id="dvCcReceiver" onclick="return dvCcReceiver_onclick()" border="0"><asp:DataList id="dlReceiverCc" runat="server" Width="581px" Font-Size="2px" BackColor="LightGoldenrodYellow" __designer:wfdid="w39" BorderColor="Tan" RepeatColumns="4" OnSelectedIndexChanged="dlReceiverCc_SelectedIndexChanged" BorderWidth="1px"><ItemTemplate>
...
<AlternatingItemStyle BorderColor="Tan"></AlternatingItemStyle>
</asp:DataList> </DIV></TD></TR><TR><TD><asp:Label id="lblApprove" runat="server" Text="Approve :" __designer:wfdid="w40"></asp:Label></TD><TD style="WIDTH: 621px" class="tblTDLeft"><asp:CheckBox id="chkApprove" runat="server" __designer:wfdid="w41"></asp:CheckBox>&nbsp; <asp:Label id="lbltitle" runat="server" Text="( यस बमोजिम स्वीकार्थ पेश गरेको छु । )" SkinID="Unicodelbl" __designer:wfdid="w42"></asp:Label></TD></TR></TBODY></TABLE></FIELDSET> 
</contenttemplate>
                                    <triggers>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 27px" align=left colSpan=2><TABLE style="WIDTH: 451px"><TBODY><TR><TD style="WIDTH: 75px"><asp:Label id="Label2" runat="server" Text="पठाउनु पर्ने" __designer:wfdid="w111"></asp:Label> </TD><TD style="WIDTH: 131px" class="tblTDLeft"><asp:DropDownList id="ddlFilterReceiver" runat="server" OnSelectedIndexChanged="ddlFilterReceiver_SelectedIndexChanged" __designer:wfdid="w112" AutoPostBack="True"><asp:ListItem Value="-1">छान्नुहोस्</asp:ListItem>
<asp:ListItem Value="1">संस्था</asp:ListItem>
<asp:ListItem Value="2">शाखा</asp:ListItem>
<asp:ListItem Value="3">व्यक्ति</asp:ListItem>
</asp:DropDownList> </TD><TD><asp:Label id="lblOrganisation" runat="server" Text="संस्था" __designer:wfdid="w113"></asp:Label> </TD><TD class="tblTDLeft"><asp:DropDownList id="ddlOrg" runat="server" Width="200px" OnSelectedIndexChanged="ddlOrg_SelectedIndexChanged" __designer:wfdid="w114" AutoPostBack="True" Enabled="False"></asp:DropDownList> </TD></TR><TR><TD style="WIDTH: 75px; HEIGHT: 32px"></TD><TD style="WIDTH: 131px; HEIGHT: 32px" class="tblTDLeft"></TD><TD style="HEIGHT: 32px"><asp:Label id="lblUnit" runat="server" Text="शाखा" __designer:wfdid="w115"></asp:Label> </TD><TD style="HEIGHT: 32px" class="tblTDLeft"><asp:DropDownList id="ddlUnit" runat="server" Width="122px" OnSelectedIndexChanged="ddlUnit_SelectedIndexChanged" __designer:wfdid="w116" AutoPostBack="True" Enabled="False"></asp:DropDownList> <asp:ImageButton id="imgPplBooking" onclick="imgPplBooking_Click" runat="server" ImageUrl="~/MODULES/OAS/Images/Book [1600x1200].jpg" ToolTip="नयाँ स्थल बुकिङ्ग" __designer:wfdid="w1"></asp:ImageButton></TD></TR></TBODY></TABLE></TD></TR><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left colSpan=1><asp:UpdatePanel id="UpdatePanel111" runat="server" __designer:wfdid="w117"><ContentTemplate>
<asp:CheckBox id="chkAllPeople" runat="server" __designer:wfdid="w118"></asp:CheckBox> <asp:Label id="lblSelectAllPpl" runat="server" Text="Select All" __designer:wfdid="w119"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right><asp:TextBox id="txtSearchPeople" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w120" AutoPostBack="True" OnTextChanged="txtSearchPeople_TextChanged"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updPeople" runat="server" __designer:wfdid="w121"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 217px" id="divGridPpl" border="0"><asp:GridView id="grdPeople" runat="server" Width="300px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w122" OnRowCreated="grdPeople_RowCreated" ShowHeader="False" GridLines="None" OnRowDataBound="grdPeople_RowDataBound">
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left><asp:UpdatePanel id="UpdatePanel11" runat="server" __designer:wfdid="w93"><ContentTemplate>
<asp:CheckBox id="chkAllCategories" runat="server" __designer:wfdid="w94"></asp:CheckBox> <asp:Label id="lblSelectAllCategories" runat="server" Text="Select All" __designer:wfdid="w95"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right><asp:TextBox id="txtSearchCategory" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w96" AutoPostBack="True" OnTextChanged="txtSearchCategory_TextChanged"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updCategory" runat="server" __designer:wfdid="w97"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 213px" id="divGridGrp" border="0"><asp:GridView id="grdCategory" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w98" OnRowCreated="grdCategory_RowCreated" ShowHeader="False" GridLines="None" OnRowDataBound="grdCategory_RowDataBound" AutoGenerateColumns="False">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0><TBODY><TR style="BACKGROUND-COLOR: #eeeeed"><TD style="PADDING-LEFT: 5px; HEIGHT: 24px" align=left><asp:UpdatePanel id="updChkGroup" runat="server" __designer:wfdid="w81"><ContentTemplate>
<asp:CheckBox id="chkAllGroups" runat="server" __designer:wfdid="w82"></asp:CheckBox> <asp:Label id="lblSelectAllGroups" runat="server" Text="Select All" __designer:wfdid="w83"></asp:Label> 
</ContentTemplate>
</asp:UpdatePanel> </TD><TD style="PADDING-RIGHT: 5px; HEIGHT: 24px" align=right>&nbsp;<asp:TextBox id="txtSearchGroup" runat="server" CssClass="SearchTxt" Width="300px" __designer:wfdid="w84" AutoPostBack="True" OnTextChanged="txtSearchGroup_TextChanged"></asp:TextBox> </TD></TR><TR><TD align=left colSpan=2><asp:UpdatePanel id="updGroup" runat="server" __designer:wfdid="w85"><ContentTemplate>
<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 213px" id="Div2" border="0"><asp:GridView id="grdGroup" runat="server" Width="249px" ForeColor="#333333" EnableTheming="False" CellPadding="4" __designer:wfdid="w86" OnRowCreated="grdGroup_RowCreated" ShowHeader="False" GridLines="None" AutoGenerateColumns="False">
<FooterStyle BackColor="#5D7B9D" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:TemplateField>
<ItemStyle Width="5%"></ItemStyle>
