<%@ Page AutoEventWireup="true" CodeFile="PostingTippaniRequestViewer.aspx.cs" Inherits="MODULES_OAS_Tippani_PostingTippaniRequestViewer"
    Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Posting Tippani Viewer"
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="width: 100%; height: auto">
        ...
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="नियुक्तिको टिप्पणी चलानी"></asp:Label>
        <asp:HiddenField ID="hdnTippaniStatus" runat="server" />
        <br />
        <TRV:TippaniRequestViewer ID="TippaniRequestViewer" runat="server" TippaniSubjectType="Posting" />
        <br />
        <cc1:TabContainer ID="EvaluationTab" runat="server" ActiveTabIndex="0" CssClass="ajax_tab_theme" ScrollBars="Auto" Width="100%">
            <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                <contenttemplate>
&nbsp;<asp:Label id="Label2" runat="server" Text="नियुक्तिको लागी कर्मचारीहरु" SkinID="UnicodeHeadlbl"></asp:Label> <asp:HiddenField id="hdnForm" runat="server" Value="0"></asp:HiddenField> &nbsp;<BR /><asp:GridView id="grdPostList" runat="server" Width="100%" OnRowDataBound="grdPostList_RowDataBound" __designer:wfdid="w41" ForeColor="#333333" CellPadding="0" AutoGenerateColumns="False">
<AlternatingRowStyle BackColor="White" ForeColor="#284775" __designer:dtid="37436201967288408"></AlternatingRowStyle>
<Columns>
...
<asp:BoundField DataField="PostOrgID" HeaderText="OrgID"></asp:BoundField>
...
<asp:BoundField DataField="PostingTypeID" HeaderText="PostingTypeID"></asp:BoundField>
<asp:BoundField DataField="PostOrgName" HeaderText="कार्यालय"></asp:BoundField>
<asp:BoundField DataField="PostDesName" HeaderText="पद"></asp:BoundField>
<asp:BoundField DataField="PostName" HeaderText="पोस्ट"></asp:BoundField>
<asp:BoundField DataField="PostingTypeName" HeaderText="छनौट तरिका"></asp:BoundField>
<asp:BoundField DataField="FromDate" HeaderText="नियुत्ति मिति"></asp:BoundField>
...
टिप्पनीको इतिहास&nbsp; 
        ...
        <br />
        <uc1:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="3" />
        <br />
        <table width="500">
            <tr>
