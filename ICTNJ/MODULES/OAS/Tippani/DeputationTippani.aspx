<%@ Page AutoEventWireup="true" CodeFile="DeputationTippani.aspx.cs" Inherits="MODULES_OAS_Tippani_DeputationTippani" Language="C#"
    MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Deputation Tippani" ValidateRequest="false" %>

<%@ Register Src="../UserControls/DeputationEntry.ascx" TagName="DeputationEntry" TagPrefix="uc7" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateTippani()
        {
            ...
            var table = document.getElementById('<%= this.DeputationEntry.DeputationGrid.ClientID%>');
            if(table == null)
            {
                alert('कृपया काजको लागी कर्मचारी राख्नोहोस।');
                //var cntl = document.getElementById('<%= this.DeputationEntry.Note.ClientID%>');
                //cntl.focus();
                return false;
            }
...
//            }
    ...
    <div id="DIV1" style="width: 100%; height: auto">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 100%">
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="काजको टिप्पणी"></asp:Label>
                    &nbsp; &nbsp;&nbsp;
        ...
        <uc3:Tippani ID="Tippani" runat="server" TippaniSubjectID="6" TippaniSubjectType="Deputation" />
        <hr align="left" width="100%" />
        <uc1:GroupMemberPersonSearch ID="ggrdMemberSearch" runat="server" ApplicationString="5, 3" TippaniSubjectID="2" />
        <hr />
        <uc7:DeputationEntry ID="DeputationEntry" runat="server" />
        <hr align="left" width="100%" />
        <uc5:TippaniAttachment ID="TippaniAttachment" runat="server" />
        <hr align="left" width="100%" />
        <uc2:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="6" />
        <br />
        <table width="100%">
            <tr>
                <td style="width: 100%">
                    <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" OnClientClick="return ValidateTippani();" SkinID="Normal" Text="Submit" />
