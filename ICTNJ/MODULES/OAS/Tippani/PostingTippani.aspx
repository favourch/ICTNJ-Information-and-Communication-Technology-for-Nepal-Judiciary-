<%@ Page AutoEventWireup="true" CodeFile="PostingTippani.aspx.cs" Inherits="MODULES_OAS_Tippani_PostingTippani" Language="C#"
    MaintainScrollPositionOnPostback="true" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Posting Tippani" ValidateRequest="false" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateTippani()
        {
            ...
            var table = document.getElementById('<%= this.PostingEntry.PostingGrid.ClientID%>');
            if(table == null)
            {
                alert('कृपया नियुक्तिको लागी कर्मचारी राख्नोहोस।');
                //var cntl = document.getElementById('<%= this.PostingEntry.Note.ClientID%>');
                //cntl.focus();
                return false;
            }
...
//            }
    ...
    <div id="DIV1" style="width: 100%; height: auto">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 100%">
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="नियुक्तिको टिप्पणी"></asp:Label>
                    &nbsp;&nbsp; &nbsp;
        ...
        <uc3:Tippani ID="Tippani" runat="server" TippaniSubjectID="3" TippaniSubjectType="Posting" />
        <hr align="left" width="100%" />
        <uc1:GroupMemberPersonSearch ID="ggrdMemberSearch" runat="server" ApplicationString="5, 3" TippaniSubjectID="2" />
        <hr />
        <uc4:PostingEntry ID="PostingEntry" runat="server" />
        <hr align="left" width="100%" />
        <uc5:TippaniAttachment ID="TippaniAttachment" runat="server" />
        <hr align="left" width="100%" />
        <uc2:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="3" />
        <br />
        <table width="100%">
            <tr>
                <td style="width: 100%">
