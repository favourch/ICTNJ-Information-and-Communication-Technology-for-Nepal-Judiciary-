<%@ Page AutoEventWireup="true" CodeFile="TrainingTippaniRequestViewer.aspx.cs" Inherits="MODULES_OAS_Tippani_TrainingTippaniRequestViewer"
    Language="C#" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Training Tippani Viewer" ValidateRequest="false" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="width: 100%; height: auto">
        ...
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="तालिमको टिप्पणी चलानी"></asp:Label>
        <asp:HiddenField ID="hdnTippaniStatus" runat="server" />
        <br />
        <TRV:TippaniRequestViewer ID="TippaniRequestViewer" runat="server" TippaniSubjectType="Training" />
        <br />
        <cc1:TabContainer ID="EvaluationTab" runat="server" ActiveTabIndex="0" CssClass="ajax_tab_theme" ScrollBars="Auto" Width="100%">
            <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                <contenttemplate>
&nbsp;<asp:Label id="Label2" runat="server" Text="तालिमको लागी कर्मचारीहरु" SkinID="UnicodeHeadlbl"></asp:Label> <asp:HiddenField id="hdnForm" runat="server" Value="0"></asp:HiddenField> &nbsp;<asp:GridView id="grdTraining" runat="server" Width="900px" SkinID="Unicodegrd" OnRowDataBound="grdTraining_RowDataBound" ForeColor="#333333" CellPadding="0" AutoGenerateColumns="False">
...
<asp:BoundField DataField="TrnInstitutionID" HeaderText="InstitutionID"></asp:BoundField>
<asp:BoundField DataField="TrnInstitutionName" HeaderText="संस्थाको नाम"></asp:BoundField>
<asp:BoundField DataField="TrnSubject" HeaderText="शिर्षक"></asp:BoundField>
<asp:BoundField DataField="TrnFromDate" HeaderText="अवधि देखि"></asp:BoundField>
<asp:BoundField DataField="TrnToDate" HeaderText="अवधि सम्म"></asp:BoundField>
<asp:BoundField DataField="TrnRemark" HeaderText="कैफियत"></asp:BoundField>
</Columns>
...
टिप्पनीको इतिहास&nbsp; 
        ...
        <br />
        <uc1:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="5" />
        <br />
        <table width="500">
            <tr>
