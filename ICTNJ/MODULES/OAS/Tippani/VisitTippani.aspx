<%@ Page AutoEventWireup="true" CodeFile="VisitTippani.aspx.cs" Inherits="MODULES_OAS_Tippani_VisitTippani" Language="C#"
    MaintainScrollPositionOnPostback="true" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Visit Tippani" ValidateRequest="false" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateTippani()
        {
            ...
            var table = document.getElementById('<%= this.VisitTippani.VisitorGrid.ClientID%>');
            if(table == null)
            {
                alert('कृपया भ्रमणको लागी कर्मचारी राख्नोहोस।');
                //var cntl = document.getElementById('<%= this.VisitTippani.Note.ClientID%>');
                //cntl.focus();
                return false;
            }
...
//            }
    ...
    <div id="DIV1" style="width: 100%; height: auto">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 100%">
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="भ्रमणको टिप्पणी"></asp:Label>
                    &nbsp; &nbsp;&nbsp;
        ...
        <asp:HiddenField ID="hdnIDs" runat="server" /><asp:HiddenField ID="hdnMsgIDs" runat="server" />
        ...
        <uc3:Tippani ID="Tippani" runat="server" TippaniSubjectID="2" TippaniSubjectType="Visit" />
        <hr align="left" width="100%" />
        <uc1:GroupMemberPersonSearch ID="ggrdMemberSearch" runat="server" ApplicationString="5, 3" TippaniSubjectID="2" />
        <hr />
        <uc4:VisitEntry ID="VisitTippani" runat="server" />
        <hr align="left" width="100%" />
        <uc5:TippaniAttachment ID="TippaniAttachment" runat="server" />
        <hr align="left" width="100%" />
        <uc2:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="2" />
        <br />
        <table width="100%">
            <tr>
                <td style="width: 100%">
