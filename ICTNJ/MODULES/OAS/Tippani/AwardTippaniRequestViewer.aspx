<%@ Page AutoEventWireup="true" CodeFile="AwardTippaniRequestViewer.aspx.cs" Inherits="MODULES_OAS_Tippani_AwardTippaniRequestViewer"
    Language="C#" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Award Tippani Viewer" ValidateRequest="false" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="width: 100%; height: auto">
        ...
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="बिभुषणको टिप्पणी चलानी"></asp:Label><br />
        <asp:HiddenField ID="hdnTippaniStatus" runat="server" />
        <br />
        <TRV:TippaniRequestViewer ID="TippaniRequestViewer" runat="server" TippaniSubjectType="Award" />
        <br />
        <cc1:TabContainer ID="EvaluationTab" runat="server" ActiveTabIndex="0" CssClass="ajax_tab_theme" ScrollBars="Auto" Width="100%">
            <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                <contenttemplate>
&nbsp;<asp:Label id="Label2" runat="server" Text="बिभुषणको लागी कर्मचारीहरु" SkinID="UnicodeHeadlbl"></asp:Label> <asp:HiddenField id="hdnForm" runat="server" Value="0"></asp:HiddenField> <asp:GridView id="grdAward" runat="server" Width="850px" SkinID="Unicodegrd" ForeColor="#333333" CellPadding="0" AutoGenerateColumns="False">
<AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
<Columns>
<asp:BoundField DataField="EmpName" HeaderText="कर्मचारीको नाम"></asp:BoundField>
<asp:BoundField DataField="AwardDate" HeaderText="मिति"></asp:BoundField>
<asp:BoundField DataField="Award" HeaderText="बिभुषणको बिबरण"></asp:BoundField>
<asp:BoundField DataField="AwardRemark" HeaderText="कैफियत"></asp:BoundField>
</Columns>
...
टिप्पनीको इतिहास&nbsp; 
        ...
        <br />
        <uc1:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="8" />
        <br />
        <table width="500">
            <tr>
