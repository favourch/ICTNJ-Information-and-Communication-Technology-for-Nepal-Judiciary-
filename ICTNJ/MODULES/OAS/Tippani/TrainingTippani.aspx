<%@ Page AutoEventWireup="true" CodeFile="TrainingTippani.aspx.cs" Inherits="MODULES_OAS_Tippani_TrainingTippani" Language="C#"
    MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Training Tippani" ValidateRequest="false" %>

<%@ Register Src="../UserControls/TrainingEntry.ascx" TagName="TrainingEntry" TagPrefix="uc6" %>

<%@ Register Src="../UserControls/PostingEntry.ascx" TagName="PostingEntry" TagPrefix="uc4" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateTippani()
        {
            ...
            var table = document.getElementById('<%= this.TrainingEntry.TraineeGrid.ClientID%>');
            if(table == null)
            {
                alert('कृपया तालिमको लागी कर्मचारी राख्नोहोस।');
                //var cntl = document.getElementById('<%= this.TrainingEntry.Note.ClientID%>');
                //cntl.focus();
                return false;
            }
...
//            }
    ...
    <div id="DIV1" style="width: 100%; height: auto">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 100%">
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="तालिमको टिप्पणी"></asp:Label>
                    &nbsp; &nbsp;&nbsp;
        ...
        <uc3:Tippani ID="Tippani" runat="server" TippaniSubjectID="5" TippaniSubjectType="Training" />
        <hr align="left" width="100%" />
        <uc1:GroupMemberPersonSearch ID="ggrdMemberSearch" runat="server" ApplicationString="5, 3" TippaniSubjectID="2" />
        <hr />
        <uc6:TrainingEntry id="TrainingEntry" runat="server">
        </uc6:TrainingEntry>
        <hr align="left" width="100%" />
        <uc5:TippaniAttachment ID="TippaniAttachment" runat="server" />
        <hr align="left" width="100%" />
        <uc2:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="5" />
        <br />
        <table width="100%">
            <tr>
                <td style="width: 100%">
