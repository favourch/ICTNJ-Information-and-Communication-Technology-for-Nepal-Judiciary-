<%@ Page AutoEventWireup="true" CodeFile="LeaveTippaniRequestViewer.aspx.cs" Inherits="MODULES_OAS_Tippani_LeaveTippaniRequestViewer"
    Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Leave Tippani Viewer(Request)"
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateForm()
        {
            ...
            {
                alert('कृपया बिदाको सिफरिस बिबरण राख्नुहोस ।');
                fromDate.focus();
                return false;
            }
            ...
            {
                alert('कृपया सबै कर्मचारीको लागी बिदाको सिफरिस बिबरण राख्नुहोस ।');
                fromDate.focus();
                return false;
            }
        ...
        function ValidateLeaveDetail()
        {
            try
            {
                ...
                if(chk.checked == true)
                {
                    ...
                    {
                        alert('सिफारिसको अवधि देखि मिति अनुरोधको अवधि देखि मिति भन्दा सानो हुन सक्दैन् ।');
                        fromDate.focus();
                        return false;
                    }
                    ...
                    {
                        alert('सिफारिसको अवधि सम्म मिति अनुरोधको अवधि सम्म मिति भन्दा ठुलो हुन सक्दैन् ।');
                        toDate.focus();
                        return false;
                    }
                }
...
टिप्पणीको बिबरण 
                ...
                <contenttemplate>
<asp:Label id="Label451" runat="server" Text="कर्मचारीको बिदाको अनुरोध बिबरण" SkinID="UnicodeHeadlbl"></asp:Label> &nbsp;&nbsp; &nbsp;<asp:Label id="lblLeaveStatus" runat="server" SkinID="Unicodelbl" Font-Bold="True"></asp:Label> <BR /><asp:UpdatePanel id="updRecPanel" runat="server"><ContentTemplate>
...
<asp:BoundField DataField="ReqFromDate" HeaderText="अवधि देखि"></asp:BoundField>
<asp:BoundField DataField="ReqToDate" HeaderText="अवधि सम्म"></asp:BoundField>
<asp:BoundField DataField="ReqNoOfDays" HeaderText="जम्मा दिन"></asp:BoundField>
<asp:BoundField DataField="ReqReason" HeaderText="कैफियत"></asp:BoundField>
...
<asp:BoundField DataField="RDRecYesNo" HeaderText="सिफारिस"></asp:BoundField>
