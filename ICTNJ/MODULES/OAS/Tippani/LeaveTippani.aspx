<%@ Page AutoEventWireup="true" CodeFile="LeaveTippani.aspx.cs" Inherits="MODULES_OAS_Tippani_LeaveTippani" Language="C#"
    MaintainScrollPositionOnPostback="true" ValidateRequest="false" MasterPageFile="~/MODULES/OAS/MasterPage.master" Title="OAS | Leave Tippani" %>

<%@ Register Src="../UserControls/LeaveEntry.ascx" TagName="LeaveEntry" TagPrefix="uc4" %>
...
<asp:Content ID="Content1" runat="Server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <script language="javascript" type="text/javascript">
        function ValidateTippani()
        {
            ...
            var table = document.getElementById('<%= this.LeaveEntry.LeaveGrid.ClientID%>');
            if(table == null)
            {
                alert('कृपया बिदाको लागी कर्मचारी राख्नोहोस।');
                return false;
            }
...
//            }
        ...
        function OnGetMessageSuccessx(result, userContext, methodName)
        {
            alert(result);
        }
        
        function OnGetMessageFailurex(error, userContext, methodName) 
        {
            alert(error);
        }
    </script>
    ...
    <div id="DIV1" style="width: 100%; height: auto">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 100%">
        <asp:Label ID="Label1" runat="server" SkinID="UnicodeHeadlbl" Text="बिदाको टिप्पणी"></asp:Label>
                    &nbsp;&nbsp; &nbsp;
        ...
        <uc3:Tippani ID="Tippani" runat="server" TippaniSubjectID="1" TippaniSubjectType="Leave" />
        <hr align="left" width="100%" />
        <uc1:GroupMemberPersonSearch ID="ggrdMemberSearch" runat="server" ApplicationString="5, 3" TippaniSubjectID="2" />
        <hr />
        <uc4:LeaveEntry ID="LeaveEntry" runat="server" />
        <%--<uc4:LeaveEntry ID="LeaveEntry1" runat="server" />--%>
        <hr align="left" width="100%" />
        <uc5:TippaniAttachment ID="TippaniAttachment" runat="server" />
        <hr align="left" width="100%" />
        <uc2:ChannelPerson ID="chnlPerson" runat="server" ApplicationString="5, 3" TippaniSubjectID="1" />
        <br />
        <table width="100%">
            <tr>
                <td style="width: 100%">
