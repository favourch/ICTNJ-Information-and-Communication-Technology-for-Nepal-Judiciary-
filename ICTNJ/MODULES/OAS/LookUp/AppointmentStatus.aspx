<%@ Page Language="C#" MasterPageFile="~/MODULES/OAS/MasterPage.master" AutoEventWireup="true" CodeFile="AppointmentStatus.aspx.cs" Inherits="MODULES_OAS_LookUp_AppointmentStatus" Title="OAS | Appointment Status" %>
        ...
        <table height="370" width="800">
            <tr>
                <td rowspan="2" style="width: 250px" valign="top">
                    <asp:ListBox ID="lstAppointmentStatus" runat="server" AutoPostBack="True" Height="375px" SkinID="Unicodelst"
                        Width="230px" OnSelectedIndexChanged="lstAppointmentStatus_SelectedIndexChanged" ></asp:ListBox></td>
                <td height="340" style="width: 550px" valign="top">
                    <table width="500">
                        <tr>
                            <td style="width: 130px">
                                <asp:Label ID="lblAppointmentStatus" runat="server" SkinID="Unicodelbl" Text="Appointment Status"></asp:Label></td>
                            <td style="width: 370px">
                                <asp:TextBox ID="txtAppointmentStatus" runat="server" SkinID="Unicodetxt" Width="260px"></asp:TextBox></td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td height="30" style="width: 550px" valign="bottom">
                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" SkinID="Normal" OnClick="btnSubmit_Click" />
