<%@ Page Language="C#" MasterPageFile="~/MODULES/OAS/MasterPage.master" AutoEventWireup="true" CodeFile="Group.aspx.cs" Inherits="MODULES_OAS_LookUp_Group" Title="Add Group" %>
            ...
            <tr>
                ...
                <td style="width: 450px" valign="top" height="370">
                    <table width="450">
                        ...
                        <tr>
                            <td style="width: 100px">
                                <asp:Label ID="Label2" runat="server" SkinID="Unicodelbl" Text="समूह"></asp:Label></td>
                            <td style="width: 350px">
