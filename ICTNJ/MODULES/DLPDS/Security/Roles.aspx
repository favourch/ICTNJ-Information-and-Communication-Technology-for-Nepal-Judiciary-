<%@ Page Language="C#" MasterPageFile="~/MODULES/DLPDS/DLPDSMasterPage.master" AutoEventWireup="true" CodeFile="Roles.aspx.cs" Inherits="MODULES_DLPDS_Security_Roles" Title="DLPDS | Roles" %>
<%@ Register 
...
<asp:Button ID="OkButton" runat="server" Text="OK" OnClick="hideModalPopupViaServer_Click" Width="58px" />           <br />
    ...
    <table cellspacing="5">
        <tr>
            <td valign="top">
                <asp:Label ID="Label2" runat="server" Text="Application"></asp:Label></td>
            <td colspan="3" valign="top" style="width: 518px">
                <asp:DropDownList ID="ddlApplication_Rqd" runat="server" Width="275px" AutoPostBack="True" OnSelectedIndexChanged="ddlApplication_Rqd_SelectedIndexChanged" ToolTip="Application">
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td valign="top">
                <asp:Label ID="Label3" runat="server" Text="Role Name"></asp:Label></td>
            <td colspan="3" style="width: 518px" valign="top">
                <asp:TextBox ID="txtRoleName_Rqd" runat="server" MaxLength="20" ToolTip="Role Name" Width="268px"></asp:TextBox><ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Custom, UppercaseLetters, LowercaseLetters"
        ...
        <tr>
            <td valign="top">
                <asp:Label ID="Label4" runat="server" Text="Role Description" Width="99px"></asp:Label></td>
            <td valign="top" style="width: 518px" colspan="3">
                <asp:TextBox ID="txtRoleDesc_Rqd" runat="server" MaxLength="100" Width="506px" Height="27px" TextMode="MultiLine" onkeypress="return textboxMultilineMaxNumber(this,50)" ToolTip="Role Description"></asp:TextBox><ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server" FilterType="Custom, UppercaseLetters, LowercaseLetters"
    ...
    <table style="width: 633px">
        <tr>
            <td style="width: 266px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="List of Roles" Width="86px"></asp:Label></td>
            <td style="width: 22540px">
            </td>
            <td style="width: 322px">
                <asp:Label ID="lblMenus" runat="server" Font-Bold="True" Text="List of Menus"></asp:Label></td>
        </tr>
        <tr>
            <td style="width: 266px">
                <asp:ListBox AutoPostBack="True" Height="304px" ID="lstRoles" OnSelectedIndexChanged="lstRoles_SelectedIndexChanged" runat="server" Width="250px">
            </asp:ListBox></td>
            <td style="width: 22540px">
            </td>
            <td style="width: 322px">
                <asp:Panel ID="Panel3" runat="server" Height="300px" Width="604px" ScrollBars="Auto">
                    <asp:GridView ID="grdApplMenus" runat="server" AutoGenerateColumns="False" CellPadding="1"
                        CellSpacing="2" ForeColor="#333333" GridLines="None" OnRowDataBound="grdApplMenus_RowDataBound"
                        SkinID="gvArial" Style="position: static" Width="400px">
        ...
        <tr>
            ...
            <asp:Button ID="btnOK" runat="server" Text="OK" Width="65px" OnClick="btnOK_Click" OnClientClick="javascript:return validate();"   /><asp:Button ID="btnCancel" runat="server" Text="Cancel" OnClick="btnCancel_Click"/></td>
        </tr>
    </table>
    <br />
</asp:Content>
