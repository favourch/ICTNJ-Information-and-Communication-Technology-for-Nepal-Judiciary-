...
<asp:TemplateField HeaderText="Header 1"><FooterTemplate>
                                            <asp:Button id="btnAddRow" tabIndex=104 onclick="btnAddRow_Click" runat="server" Text="थप्नुहोस्" __designer:wfdid="w6" OnClientClick="javascript: return totalValidate(1);"></asp:Button> 
...
<BR /><asp:GridView id="grdAmountDate" runat="server" __designer:wfdid="w2" OnRowDataBound="grdAmountDate_RowDataBound" OnRowCreated="grdAmountDate_RowCreated" AutoGenerateColumns="False" ShowFooter="True" BorderStyle="None" ShowHeader="False">
                                            <FooterStyle BackColor="White"></FooterStyle>
                                            <Columns>
                                            ...
                                            <asp:Button id="btnAdd" tabIndex=104 onclick="btnAdd_Click" runat="server" Text="थप्नुहोस्" __designer:wfdid="w10" OnClientClick="return totalValidate(2)"></asp:Button> 
                                            </FooterTemplate>
                                            <ItemTemplate>
                                            ...
                                            </asp:GridView> <BR /><asp:Button id="btnSave" tabIndex=105 onclick="btnSave_Click" runat="server" Text="save" __designer:wfdid="w3" OnClientClick="javascript: return totalValidate(0);" Visible="False"></asp:Button> 
</contenttemplate>
                                                                                                                                                                                           <triggers>
