<%@ Page AutoEventWireup="true" CodeFile="TameliInfo.aspx.cs" Inherits="MODULES_CMS_ReportForms_TameliInfo"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width: 826px">
        ...
        <tr>
            ...
            <td align="left" style="width: 258px; height: 31px;" valign="middle">
            ...
            <td align="left" style="width: 128px; height: 31px;" valign="middle">
        ...
        <tr>
            <td align="left" style="height: 21px" valign="top">
                <asp:Label ID="Label4" runat="server" SkinID="Unicodelbl" Text="तामेलि प्रकार" Width="92px"></asp:Label></td>
            <td align="left" style="width: 258px; height: 21px" valign="top"><asp:DropDownList ID="DDLMyaadType" runat="server" SkinID="Unicodeddl" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="DDLOrgWithChilds_SelectedIndexChanged">
            </asp:DropDownList></td>
