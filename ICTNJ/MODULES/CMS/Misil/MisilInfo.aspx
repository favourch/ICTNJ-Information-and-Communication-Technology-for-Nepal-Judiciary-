<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MisilInfo.aspx.cs" Inherits="MODULES_CMS_Misil_MisilInfo" Title="Misil Info" %>
...
function PassValues()
{
    ...
    {
        return ValidateEmail('<%=this.txtEMail_EMail.ClientID %>');
    }
    </script>
<form id="form1"  runat="server">
    ...
    <asp:Panel ID="programmaticPopup" runat="server" CssClass="modalPopup" Style="display: none;
        ...
        <table cellspacing="5" style="width: 1000px">
            ...
            <tr>
                <td align="left" colspan="6" valign="top" style="height: 361px">
