...
{
    public class DLLCaseDocumentLit
    {
        public static bool SaveCaseDocumentLit(List<ATTCaseDocumentsLit> CaseDocumentLitLST, OracleTransaction Tran)
        {
            ...
            try
            {
                ...
                foreach (ATTCaseDocumentsLit objCaseDocument in CaseDocumentLitLST)
                {
                    ...
                    paramArray.Add(Utilities.GetOraParam(":P_LITIGANT_ID", objCaseDocument.LitigantID, OracleDbType.Double, ParameterDirection.Input));
                    paramArray.Add(Utilities.GetOraParam(":P_DOCUMENT_ID", objCaseDocument.DocumentID, OracleDbType.Int16, ParameterDirection.Input));
                    ...
                    if (objCaseDocument.Action == "A")
                        InsertUpdateSQL = "SP_ADD_CASE_DOC_LIT";
                    else if (objCaseDocument.Action == "E")
                        InsertUpdateSQL = "SP_EDIT_CASE_DOC_LIT";
        ...
        public static DataTable GetCaseDocuments(double? CaseID,double?litigantID, int? documentID)
        {

            string SelectSql = "SP_GET_CASE_DOC_LIT";
